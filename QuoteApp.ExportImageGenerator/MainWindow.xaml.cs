...
namespace QuoteApp.ExportImageGenerator
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _theme = "Bullshit and nonsense";

            _backgroundDay = new BitmapImage(new Uri("pack://application:,,,/QuoteApp.ExportImageGenerator;component/BackgroundImageDay.png"));
            GeneratedImageDay.Source = new ImageGenerator().GenerateImageWithQuote(_backgroundDay, _textDay, _autor, _theme, Color.FromRgb(14, 14, 14));
            ...
            GeneratedImageNight.Source = new ImageGenerator().GenerateImageWithQuote(_backgroundNight, _textNight, _autor, _theme, Color.FromRgb(255, 255, 236));
        }
    }
}
